...
export default function NewProjectPage() {
  ...
  return (
    // ↓ Only change: p-8 → p-4 sm:p-8 for mobile padding
    <div className="p-4 sm:p-8">
      ...
      {/* max-w-3xl stays; w-full ensures it fills on mobile */}
      <form onSubmit={handleSubmit} className="max-w-3xl w-full space-y-6">
        ...
        {/* ── LOCATION + YEAR — side by side on sm+, stacked on mobile ── */}
        ...
        <div>
          ...
          {/* Uploaded images grid — 2 cols on mobile, 3 on sm+ */}
          {gallery.length > 0 && (
        ...
        <div>
          ...
          {/* Mode toggle — wraps naturally on very small screens */}
        ...
        {/* ── SUBMIT — stack on mobile, row on sm+ ── */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-4">
          <button
            type="submit"
            disabled={submitting || coverUploading || galleryUploading || videoUploading}
            className="px-8 py-3 rounded-full font-semibold text-sm transition-all hover:opacity-90 disabled:opacity-50 text-center"
          ...
          <Link
            href="/admin/projects"
            className="px-8 py-3 rounded-full font-semibold text-sm transition-all text-center"
