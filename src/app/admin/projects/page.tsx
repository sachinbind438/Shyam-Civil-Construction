              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="shrink-0">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-lg overflow-hidden bg-white/10">
                      {p.coverImage && (
                        // eslint-disable-next-line @next/next/no-img-element
                        <img src={p.coverImage} alt="" className="w-full h-full object-cover" />
                      )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="min-w-0 flex-1">
                        <p className="text-white text-base sm:text-lg font-medium mb-1">{p.title}</p>
                        <p className="text-white/30 text-xs sm:text-sm mb-2">/projects/{p.slug}</p>
                      </div>
                    </div>
